...
export const GetFoodNamesDocument = gql`
    query getFoodNames {
  foods {
    id
    name {
...
/**
 * __useGetFoodNamesQuery__
 *
 * To run a query within a React component, call `useGetFoodNamesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetFoodNamesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetFoodNamesQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetFoodNamesQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetFoodNamesQuery, GetFoodNamesQueryVariables>) {
        return ApolloReactHooks.useQuery<GetFoodNamesQuery, GetFoodNamesQueryVariables>(GetFoodNamesDocument, baseOptions);
      }
export function useGetFoodNamesLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetFoodNamesQuery, GetFoodNamesQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetFoodNamesQuery, GetFoodNamesQueryVariables>(GetFoodNamesDocument, baseOptions);
        }
export type GetFoodNamesQueryHookResult = ReturnType<typeof useGetFoodNamesQuery>;
export type GetFoodNamesLazyQueryHookResult = ReturnType<typeof useGetFoodNamesLazyQuery>;
export type GetFoodNamesQueryResult = ApolloReactCommon.QueryResult<GetFoodNamesQuery, GetFoodNamesQueryVariables>;
 ...
 * });
 */
export function useGetFoodQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetFoodQuery, GetFoodQueryVariables>) {
        return ApolloReactHooks.useQuery<GetFoodQuery, GetFoodQueryVariables>(GetFoodDocument, baseOptions);
      }
export function useGetFoodLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetFoodQuery, GetFoodQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetFoodQuery, GetFoodQueryVariables>(GetFoodDocument, baseOptions);
        }
